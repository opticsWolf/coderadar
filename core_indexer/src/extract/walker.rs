    ...
    match info.tag {
        Tag::Class => {
            ...
            ctx.units.push(ExtractedUnit::Class(ExtractedClass {
                ...
                parse_quality: super::node_quality(node),
                content_hash: super::hash_span(source, spans.full_span.start, spans.full_span.end),
        ...
        Tag::Function => {
            ...
            ctx.units.push(ExtractedUnit::Function(ExtractedFunction {
                ...
                parse_quality: super::node_quality(node),
                content_hash: super::hash_span(source, spans.full_span.start, spans.full_span.end),
                signature_hash: super::hash_span(source, spans.full_span.start, spans.body_span.start),
                body_hash: super::hash_span(source, spans.body_span.start, spans.body_span.end),
